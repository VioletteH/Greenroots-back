...
export const getAll = async (limit=10, offset=0): Promise<{ forests: Forest[]; total: number }> => {
...
export const getAllWithoutCount = async (limit=10, offset=0): Promise<{ forests: Forest[]; total: number }> => {
