...
(1, 1, 1, 'Forêt Amazonienne', 'Manguier Africain', 2, 50),  
(1, 7, 2, 'Forêts Indonésiennes', 'If Commun', 1, 150),  
(2, 2, 3, 'Zone de Reforestation du Sahel', 'Santal Blanc', 1, 200),  
(3, 3, 4, 'Forêts de Madagascar', 'Ébène du Gabon', 3, 900);  
